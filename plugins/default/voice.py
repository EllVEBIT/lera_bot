...
if answ[1] == 'скажи':
	if (answ_text == ''):
		apisay('А текст стоит вписать?&#128527;',toho,torep)
	else:
		answ_text = answ_text.replace('<br>','')
		key = 'c8694d7c-afff-48c1-9701-b10def466526'
		audio = requests.get('https://tts.voicetech.yandex.net/generate?&format=mp3&speaker=omazh&quality=hi&emotion=neutral&speed=1.2&key='+key+'&text='+str(urllib.parse.quote_plus(answ_text))).content
		#print(audio)
